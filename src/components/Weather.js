...
// Client function allows for communication with GraphQL API.
const client = createClient({
  url: "https://react.eogresources.com/graphql"
});

// Qurey to be passed as first argument to client.
const query = `
...
// Provider allows for everything within to access redux store.
export default () => {
  return (
